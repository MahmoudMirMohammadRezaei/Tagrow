...
export var defaultLocaleWeekdays = 'یک شنبه_دوشنبه_سه شنبه_چهارشنبه_پنج شنبه_جمعه_شنبه'.split('_');
export function localeWeekdays (m) {
    return this._weekdays[m.day()];
}

export var defaultLocaleWeekdaysShort = 'یک_دو_سه_چهار_پنج_جمعه_شنبه'.split('_');
export function localeWeekdaysShort (m) {
    return this._weekdaysShort[m.day()];
}

export var defaultLocaleWeekdaysMin = 'ی_د_س_چ_پ_ج_ش'.split('_');
