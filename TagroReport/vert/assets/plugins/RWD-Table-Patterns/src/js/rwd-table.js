(function ($) {
    ...
    ResponsiveTable.prototype.createButtonToolbar = function() {
        ...
        this.$dropdownBtn = $('<button class="btn btn-default dropdown-toggle" data-toggle="dropdown">نمایش <span class="caret"></span></button>');
        ...
        if(this.options.addFocusBtn) {
            ...
            // Create focus btn
            this.$focusBtn = $('<button class="btn btn-default">فوکوس</button>');
        ...
        if(this.options.addDisplayAllBtn) {
            ...
            this.$displayAllBtn = $('<button class="btn btn-default">نمایش همه</button>');
