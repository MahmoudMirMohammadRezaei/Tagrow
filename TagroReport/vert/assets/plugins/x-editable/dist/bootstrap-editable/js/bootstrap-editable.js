...
(function( $ ) {
	...
	var dates = $.fn.datepicker.dates = {
		en: {
			days: ["یک شنبه", "ئوشنبه", "سه شنبه", "چهارشنبه", "پنج شنبه", "جمعه", "شنبه", "Sunday"],
			daysShort: ["یک", "دو", "سه", "چهار", "پنج", "جمعه", "شنبه", "Sun"],
			daysMin: ["Su", "Mo", "Tu", "We", "Th", "Fr", "Sa", "Su"],
			months: ["ژانویه", "قوریه", "مارس", "آوریل", "مه", "ژوئن", "ژوئیه", "اوت", "سپتامبر", "اکتبر", "نوامبر", "دسامبر"],
